...
%
% Judul laporan.
\def\judul{Pengembangan Aplikasi \textit{Easy Mobile} Untuk Divisi Sumber Daya Manusia di PT TASPEN (Persero)}
%
% Tulis kembali judul laporan namun dengan bahasa Ingris
\def\judulInggris{Development of \textit{Easy Mobile} Application for Human Capital Division at PT TASPEN (Persero)}
...
\def\penulisSatu{I Putu Gede Kimi Agastya} % nama lengkap penulis pertama
...
\def\npmSatu{2206823695} % NPM penulis pertama
...
\def\pembimbingSatu{Iis Solichah, M.Kom., M.Comp.Sc.}
...
% penguji/sekretariat
\def\tanggalSiapSidang{26 Desember 2025}
%
% Tuliskan tanggal keputusan sidang dikeluarkan dan penulis dinyatakan
% lulus/tidak lulus
\def\tanggalLulus{26 Desember 2025}
...
\Var{\babDua}{Isi}
\Var{\babTiga}{Penutup}
% Bab berikut tidak digunakan untuk Laporan KP ini
